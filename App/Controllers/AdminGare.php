                ...
                foreach ($Righe as $key => $riga)
                {
                    ...
                    if ($key == 0)
                    {
                        if ( $ValoriRiga[0] != 'CHIP' ||
                             ...
                             $ValoriRiga[16] != 'CRUDO' ||
                             $ValoriRiga[17] != 'POSSEXCRU' ||  //aggiunta
                             $ValoriRiga[18] != 'RACETIME' ||
                             $ValoriRiga[19] != 'REALTIME' ||
                             $ValoriRiga[20] != 'ORAARRIVO' ||
                             $ValoriRiga[21] != 'DISTACCO' ||
                             $ValoriRiga[22] != 'MEDIA' ||
                             $ValoriRiga[23] != 'NOME_ENTE' ||
                             $ValoriRiga[24] != 'GIORNALIERO'
                           )
                        {
                            print "<pre>";
                            var_dump($ValoriRiga);
