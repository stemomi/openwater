...
class Share extends \Core\Controller
{
    public function CurrentRaceResults()
    {
        ...
        $RisultatiGaraOver30 = $AdminGareClass->getRisultatiGaraOver30($gara_id);
        ...
        $RisultatiGaraOver60 = $AdminGareClass->getRisultatiGaraOver60($gara_id);
        $TipoGara = 1; // Generale
        ...
        $special_guests_m_over_30 = 0;
        $special_guests_f_over_30 = 0;
        $special_guests_m_over_40 = 0;
        $special_guests_f_over_40 = 0;
        $special_guests_m_over_50 = 0;
        $special_guests_f_over_50 = 0;
        $special_guests_m_over_60 = 0;
        $special_guests_f_over_60 = 0;
        ...
        foreach($RisultatiGaraOver30 as $key => $risultato_over_30)
        {
            if ($risultato_over_30->rg_sesso == 'M')
            {
                $PosizioneSessoPerTipo = $PosizioneSessoM;
                $PosizioneSessoM++;
            }
            elseif ($risultato_over_30->rg_sesso == 'F')
            {
                $PosizioneSessoPerTipo = $PosizioneSessoF;
                $PosizioneSessoF++;
            }
            ...
            // Se squadra = 'Special Guest' incremento contatore in base al sesso
            if ($risultato_over_30->s_nome_squadra == 'Special Guest')
            {
                if ($risultato_over_30->rg_sesso == 'M')
                {
                    $special_guests_m_over_30++;
                    $PosizioneSessoPerTipo = 0;
                }
                else 
                {
                    $special_guests_f_over_30++;
                    $PosizioneSessoPerTipo = 0;
                }
            }
            ...
            if ($PosizioneSessoPerTipo != 0)
                $PosizioneSessoPerTipo =
                    $risultato_over_30->rg_sesso == 'M' ?
                    $PosizioneSessoPerTipo - $special_guests_m_over_30 :
                    $PosizioneSessoPerTipo - $special_guests_f_over_30;

            // Inietta valore
            foreach($RisultatiGaraGenerale as $key => &$risultato)
            {
                if ($risultato->rg_id == $risultato_over_30->rg_id)
                    $risultato->rg_posizione_over_30_per_sesso = $PosizioneSessoPerTipo;
            }
        }
        ...
        foreach($RisultatiGaraOver60 as $key => $risultato_over_60)
        {
            if ($risultato_over_60->rg_sesso == 'M')
            {
                $PosizioneSessoPerTipo = $PosizioneSessoM;
                $PosizioneSessoM++;
            }
            elseif ($risultato_over_60->rg_sesso == 'F')
            {
                $PosizioneSessoPerTipo = $PosizioneSessoF;
                $PosizioneSessoF++;
            }
            ...
            // Se squadra = 'Special Guest' incremento contatore in base al sesso
            if ($risultato_over_60->s_nome_squadra == 'Special Guest')
            {
                if ($risultato_over_60->rg_sesso == 'M')
                {
                    $special_guests_m_over_60++;
                    $PosizioneSessoPerTipo = 0;
                }
                else 
                {
                    $special_guests_f_over_60++;
                    $PosizioneSessoPerTipo = 0;
                }
            }
            ...
            if ($PosizioneSessoPerTipo != 0)
                $PosizioneSessoPerTipo =
                    $risultato_over_60->rg_sesso == 'M' ?
                    $PosizioneSessoPerTipo - $special_guests_m_over_60 :
                    $PosizioneSessoPerTipo - $special_guests_f_over_60;

            // Inietta valore
            foreach($RisultatiGaraGenerale as $key => &$risultato)
            {
                if ($risultato->rg_id == $risultato_over_60->rg_id)
                    $risultato->rg_posizione_over_60_per_sesso = $PosizioneSessoPerTipo;
            }
        }
    ...
    public function SharedUserRaceResult()
    {
        ...
        $RisultatiGaraOver30 = $AdminGareClass->getRisultatiGaraOver30($SharedRaceResult->A_gara_ID);
        ...
        $RisultatiGaraOver60 = $AdminGareClass->getRisultatiGaraOver60($SharedRaceResult->A_gara_ID);
        ...
        // Over 30 per genere
        $SharedRaceResult->rg_posizione_over_30_per_sesso = 0;

        if ($SharedRaceResult->categoria == 'O30M' || $SharedRaceResult->categoria == 'O30F')
        {
            $PosizioneSessoM = 1;
            $PosizioneSessoF = 1;
            ...
            foreach($RisultatiGaraOver30 as $key => $risultato_over_30)
            {
                ...
                // Inietta valore
                if ($SharedRaceResult->ID == $risultato_over_30->rg_id)
                    $SharedRaceResult->rg_posizione_over_30_per_sesso = $PosizioneSessoPerTipo;
            }
        }
        // Over 40 per genere
        ...
        // Over 60 per genere
        $SharedRaceResult->rg_posizione_over_60_per_sesso = 0;

        if ($SharedRaceResult->categoria == 'O60M' || $SharedRaceResult->categoria == 'O60F')
        {
            $PosizioneSessoM = 1;
            $PosizioneSessoF = 1;
            ...
            foreach($RisultatiGaraOver60 as $key => $risultato_over_60)
            {
                ...
                // Inietta valore
                if ($SharedRaceResult->ID == $risultato_over_60->rg_id)
                    $SharedRaceResult->rg_posizione_over_60_per_sesso = $PosizioneSessoPerTipo;
            }
        }
