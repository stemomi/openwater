...
class AdminGareModel extends \Core\Model
{
    ...
    public static function InserisciRigaRisultati($id_gara, $valori_riga)
    {
        ...
        $valori_riga[17] = str_replace('.', ':', $valori_riga[17]);
        $valori_riga[18] = str_replace('.', ':', $valori_riga[18]);
        $valori_riga[20] = str_replace('.', ':', $valori_riga[20]);
        ...
        $stmt->bindValue(':racetime', $valori_riga[17]);
        $stmt->bindValue(':realtime', $valori_riga[18]);
        $stmt->bindValue(':ora_arrivo', $valori_riga[19]);
        $stmt->bindValue(':distacco', $valori_riga[20]);
        $stmt->bindValue(':media', $valori_riga[21]);
